...
import AtomTest from '../lib/atom-test';
  ...
  describe('when the atom-test:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let atomTestElement = workspaceElement.querySelector('.atom-test');
        expect(atomTestElement).toExist();

        let atomTestPanel = atom.workspace.panelForItem(atomTestElement);
